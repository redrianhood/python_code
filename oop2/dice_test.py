...
from cheatdice import Player, CheatSwapper, CheatLoadedDice


def main():
    # create two cheater objects
    cheater1 = CheatSwapper() # ability is to change 3rd dice roll to 6
    cheater2 = CheatLoadedDice() # increase all rolls by +1 provided they are < 6
