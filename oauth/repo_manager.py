#!/usr/bin/env python3
"""
GitHub Client - OAUth and API study
"""

import json
import requests

MY_USERNAME = "rianBoren"  # own username here


def create_repo(repo_name: str, token: str) -> str:
    """
    This will create a repo for GitHub account.
    """
...
def show_repos(username: str, token: str) -> list:
    """
    This will list out all of the repos associated with GitHub account.
    """
